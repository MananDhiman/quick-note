  ...
  Scaffold(
    topBar = {
      Row(
        ...
        Icon(imageVector = Icons.Default.ArrowBack, contentDescription = "Go Back", Modifier.clickable { popBackStack() }.size(32.dp))
      }
    }
  ) {paddingValues ->
      ...
      LazyColumn(Modifier.padding(16.dp)) {
        items(notebooks.value.size) {
          ...
          Row(
            ...
            if (isNotebookEditDialogVisible.value) NotebookEditDialog(isNotebookEditDialogVisible, updateNotebook, deleteNotebook, notebooks.value[it])
          }
          Divider()
